...
<body>
	<div id="page">
		...
		<div id="contents">
			<div id="adbox">
				<img src="images/20925C00-LLYUH.jpg" alt="Img" height="444" width="630">
				<div class="info">
				  <h1>Vote Online</h1>
			...
			<!-- /#adbox -->
			<h1>Election awaits on 24 Sept Register Soon to enjoy online voting
              ...
              <form id="form1" name="form1" method="post" action="register">
                  <table width="1000" >
  <tr>
    <td><label for="textfield"> Voter-ID No:&nbsp;</label>
	        </td>
  ...
  <tr>
    <td><label for="textfield2">Name:&nbsp;</label>
            </td>
    <td><input type="text" name="name" id="textfield2"></td>
  </tr>
  <tr>
    <td> <label for="textfield3">Age:&nbsp;</label>
            </td>
  ...
  <tr>
    <td><label for="123">State:&nbsp;</label></td>
    <td>
    <select name="slist" id="123">
...
<option value="West Bengal">West Bengal</option>
  ...
  <tr>
    <td><label for="text">District:&nbsp;</label>
            </td>
    <td><input type="text" name="district" id="textfield2">&nbsp;</td>
  </tr>
  <tr>
    <td><label for="textarea">Address:&nbsp;</label>
            </td>
    <td><textarea name="address" id="textarea"></textarea>&nbsp;</td>
  </tr>
   <tr>
    <td><label for="12">Security Question :&nbsp;</label></td>
    <td>
    <select name="question" id="12">
...
<option value="number">What is your phone number?</option>
<option value="pet">What is your pet name?</option>
<option value="value">What value to you the most?</option>
    </select></td>
    </tr>
   <tr>
    <td><label for="t">Answer:&nbsp;</label>
            </td>
    <td><input type="text" name="answer" id="t">&nbsp;</td>
  </tr>
