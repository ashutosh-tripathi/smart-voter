...
<body>
	<div id="page">
		...
		<div id="contents">
			<div id="adbox">
				<img src="images/images123.jpg" alt="Img" height="444" width="630">
				<div class="info">
				  <h1>Vote Online</h1>
			...
			<div id=form><h1>Voter's Login</h1>
			  <form id="form1" name="form1" method="post" action="CheckLogin2">
			    <p>
			      <label for="textfield"> Voter-ID No:</label>
              ...
              <p>If not Registered SIGNUP NOW  <a href="signup.html"><img src="images/btn_signup.gif" width="65" height="11"  alt=""/></a></p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
			  <p>&nbsp;</p>
			</div>
